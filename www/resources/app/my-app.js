...
function getPlusInfo(){
    ...
    if(window.device) {
        ...
        localStorage.PUSH_APPID_ID = 'ios.m.quikloc8.com';
        localStorage.DEVICE_TYPE = "ios.m.quikloc8.com";
    }
}
...
var API_DOMIAN3 = "https://quiktrak.co/webapp/QuikProtect/Api2/";
...
API_URL.URL_SET_ALARM = API_DOMIAN4 + "asset/AlarmOptions";
...
App.onPageInit('asset.alarm', function (page) {
    ...
    var alarmFields = ['geolock','tilt','impact','power','input','accOff','accOn','lowBattery','positiveInputOn','positiveInputOff'];
...
function loadPageAssetAlarm(){
    ...
    mainView.router.load({
        ...
        context:{
            ...
            PositiveInputOn: alarms.positiveInputOn.state,
            PositiveInputOff: alarms.positiveInputOff.state,
        }
    });
}
...
function updateSupportUrl(){
    ...
    //API_URL.URL_SUPPORT = "https://support.quiktrak.eu/?name={0}&loginName={1}&email={2}&phone={3}";
